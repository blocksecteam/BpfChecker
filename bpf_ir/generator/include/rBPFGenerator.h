#ifndef BPF_IR_RBPFGENERATOR_H
#define BPF_IR_RBPFGENERATOR_H


#include "ProgramGenerator.h"

class RBPFGenerator : public ProgramGenerator {
public:
    RBPFGenerator();
    ~RBPFGenerator() = default;
